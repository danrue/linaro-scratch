...
curl -H "Authorization: Bearer $(cat $HOME/.config/grafana_key)" 'https://grafana.linaro.org/render/d-solo/2co7gfmZk/lkft?tab=visualization&orgId=1&from=1497989364226&var-group=lkft&var-branch=All&panelId=14&width=1000&height=500' --output grafana/total_tests_by_category.png
...
<br />
Generated with <a href="https://github.com/danrue/linaro-scratch/blob/master/work/grafana/direct.sh">https://github.com/danrue/linaro-scratch/blob/master/work/grafana/direct.sh</a>
</body>
EOF
